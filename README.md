...
![License](https://img.shields.io/badge/License-MIT-yellow) ![Render](https://img.shields.io/badge/Deploy%20on-Render-46a2f1)
...
The application includes a `render.yaml` configuration for easy deployment on [Render.com](https://render.com).
...
5. **Set environment variables** in Render dashboard:
   - `PRIVATE_KEY`: Your OpenGradient private key (optional)
   - `MEMSYNC_API_KEY`: MemSync/TwinFun API key (optional)
   - `TWINS_API_KEY`: Digital twins API key (optional)
   - `OG_EMAIL`: OpenGradient Model Hub email (optional)
   - `OG_PASSWORD`: OpenGradient Model Hub password (optional)
...
- **Custom domain**: `og-model-assistant.onrender.com`

### Post-Deployment

After deployment, visit your Render URL to access the DeFi AI Assistant Platform. The initial model sync will run automatically on first startup.
